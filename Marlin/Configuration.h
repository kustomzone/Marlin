...
#define STRING_CONFIG_H_AUTHOR "(Luis E Alvarado, Ez3D Phoenix FW, Z-Probe (servo) Dev)" // Who made the changes.
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define MIN_PROBE_EDGE 5 // The probe square sides can be no smaller than this
  ...
  #define XY_TRAVEL_SPEED 2500         // X and Y axis travel speed between probes, in mm/min
